<?php
/*
Plugin Name: List Category Posts - Template "Sofians Perfect Post List without Thumbs - http://sundari-webdesign.com/wordpress-the-quest-to-my-perfect-list-view-for-posts-events-and-articles"
...
// (Sofian: Here we open the DIV for each post.)
    $lcp_display_output .= '<div class="postlist nothumb">';
